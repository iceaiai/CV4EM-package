...
- `notebooks`: interactive development, Colab experiments, and analysis notebooks.
- `docs`: project overview and supporting documents.
- `docs/Documents`: longer workflow documentation.
- `tests`: unit tests, small test images, and test outputs.
- `outputs`: generated figures, reports, and model outputs.
- `archive`: legacy code, old outputs, old selected images, and migration logs.
